...
public class FBClientTest {
    ...
    private void init() throws IOException {
        ...
        String token = client.getAccessToken(props.getProperty("app.id").trim(),
                props.getProperty("app.secret").trim());
    ...
    public String getFieldsString(String startDate, String endDate) {
        return "feed.until(" + endDate + ").since(" + startDate
                + ").limit(10){likes{id,name,username,link,pic},comments{from,created_time,parent,likes{id,name},is_private,comment_count,like_count,is_hidden},created_time,updated_time,id,caption,from,shares}";
    }
