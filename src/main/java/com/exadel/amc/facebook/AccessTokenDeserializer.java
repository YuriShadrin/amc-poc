...
public class AccessTokenDeserializer  implements ERCResultDeserializer<String> {
	...
	@Override
	public String deserealize(ERCConfiguration configuration, int statusCode, String contentType,
			String responseBody, Class<String> resultClass) throws ERCDeserializationException {
		if(responseBody != null && responseBody.startsWith(ACCESS_TOKEN)) {
