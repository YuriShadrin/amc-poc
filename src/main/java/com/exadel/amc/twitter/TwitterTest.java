...
public class TwitterTest {
	...
	public static void main(String[] args) throws Exception {
		...
		.setOAuthConsumerKey(props.getProperty("consumer.key").trim())
	...
	public static void searchUsers(Twitter twitter, String[] searches) throws TwitterException {
		for (String search : searches) {
			...
			query.setUntil(cal.get(Calendar.YEAR) + "-" + (cal.get(Calendar.MONDAY)+1) + "-" + cal.get(Calendar.DAY_OF_MONTH));
			cal.add(Calendar.DAY_OF_MONTH, -7);
			query.setSince(cal.get(Calendar.YEAR) + "-" + (cal.get(Calendar.MONDAY)+1) + "-" + cal.get(Calendar.DAY_OF_MONTH));
			query.setCount(50);
